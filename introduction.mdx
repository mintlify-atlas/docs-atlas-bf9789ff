...
<CardGroup cols={2}>
  <Card title="Usage Metering" icon="gauge" href="/api/events/query">
  ...
  <Card title="Credit Grants" icon="wallet" href="/credits/wallets">
  ...
  <Card title="Feature Management" icon="toggle-on" href="/pricing/features">
  ...
  <Card title="Subscriptions & Invoicing" icon="file-invoice" href="/billing/invoices">
